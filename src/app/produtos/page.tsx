...
const servicesList = [
  { id: "essencia", label: "Clean Essência", active: true, href: "/produtos" },
        ...
        <div className="max-w-[1100px] w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 sm:gap-16 items-center">
          <div className="lg:col-span-6 flex flex-col gap-6 text-left">
            ...
            <p className="text-[14px] text-zinc-650 font-light leading-relaxed">
              Antes de criar a identidade, entendemos o momento da marca, seu público, seus objetivos, suas referências e a percepção que ela precisa transmitir. Essa etapa define o caminho criativo e estratégico para que a marca não seja construída apenas pela estética, mas por intenção.
            </p>
            <div className="h-[1px] w-full bg-black/5 my-2"></div>
